...
namespace ProductCatalog.Repository.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductVariantAttributeLinks",
                columns: table => new
                {
                    VariantId = table.Column<int>(type: "int", nullable: false),
                    ValueId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantAttributeLinks", x => new { x.VariantId, x.ValueId });
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributeLinks_ProductVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributeLinks_VariantAttributeValues_ValueId",
                        column: x => x.ValueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantAttributeLinks_ValueId",
                table: "ProductVariantAttributeLinks",
                column: "ValueId");
